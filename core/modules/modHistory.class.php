...
/**
 * 	\defgroup   history     Module History
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/history/core/modules directory.
 *  \file       htdocs/history/core/modules/modHistory.class.php
 *  \ingroup    history
 *  \brief      Description and activation file for module History
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module History
 */
class modHistory extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->picto='module.svg@history';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /history/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /history/core/modules/barcode)
		// for specific css file (eg: /history/css/history.css.php)
		...
		$this->url_last_version = \history\TechATM::getLastModuleVersionUrl($this);
        ...
        */
		...
		//							'titre'=>'History left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'history',
		//							'url'=>'/history/pagelevel2.php',
		//							'langs'=>'mylangfile@history',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'isModEnabled('history')',  // Define condition to show or hide menu entry. Use 'isModEnabled('history')' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->hasRight('history', 'level1', 'level2')' if you want your menu with a permission rules
		//							'target'=>'',
		//							'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		// $r++;
