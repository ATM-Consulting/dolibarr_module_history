 ...
 */
class historybox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "history@history";
    public $boxlabel;
    public $depends = array("history");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/history/class/history.class.php";
