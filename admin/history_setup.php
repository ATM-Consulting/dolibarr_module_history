...
//TODO Faire fonctionner la conf, il faut dev la feature, il y a un début de truc qui n'a jamais fonctionné, à voir avec un PO si pertinent pour un client...
// Example with a yes / no select
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$form->textwithtooltip($langs->trans("HISTORY_STOCK_FULL_OBJECT_ON_DELETE"),$langs->trans("HISTORY_STOCK_FULL_OBJECT_ON_DELETEhelp"),3,1,img_info('')).'</td>';
print '<td align="center" width="20">&nbsp;</td>';
