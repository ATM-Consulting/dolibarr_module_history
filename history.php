		...
		if ($type_object == 'deletedElement') {
			?>
					<tr class="<?php $class=($class=='impair')?'pair':'impair'; echo $class; ?>">
						...
						<td><?php echo $history->showRef() ?></td>
						<td><?php echo $history->showAction() ?></td>
						<td><?php echo $history->showWhatChanged(false, true) ?></td>
						<td><?php echo $history->showUser() ?></td>
					</tr>
					<?php
		} else {
			?>
			<tr class="<?php $class=($class=='impair')?'pair':'impair'; echo $class; ?>">
				<td><?php echo $history->get_date('date_entry', 'dayhoursec'); ?></td>
				<td><?php echo $history->showAction() ?></td>
				<td><?php echo $history->showWhatChanged() ?></td>
				<td><?php echo $history->showUser() ?></td>
			</tr>
			<?php
